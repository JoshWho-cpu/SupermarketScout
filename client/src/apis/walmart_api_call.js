...
// const consumerId = '9ec63f5b-b6be-4120-9f9d-131d48c132cf';
    ...
    categories.forEach((category, index) => {
        if (category.id == 976759) {
            ...
            children.forEach((child, idx) => {
                // console.log(`Children: ${JSON.stringify(child, null, 2)}`);
                output += `    Child ${idx + 1}: ${JSON.stringify(child, null, 2)}\n`;
            });
        }
    });

    writeFileSync('./example calls/categories_output.json', output);
